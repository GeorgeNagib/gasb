  ...
  const workshops = [
    {
      ...
      sumDesc: `The most important points and advantages offered by the Attijariwafa Group in all the countries in which it is present:
      ...
      4.Attijariwafa Bank's contribution to the promotion of trade exchange operations, especially export operations,in line with the direction of the Egyptian state with
    ...
    },
    {
      ...
      sumDesc: ` The importance of the workshop comes from the participation of various stakeholders to define a roadmap for the growth of investment and economic alliances,
    ...
    },
    {
      ...
      sumDesc: `There has been significant interest within Egypt's business sector in developing ways to adopt sustainable principles that meet the needs of both local industrial firms and the broader Egyptian community, as well as aligning with the principles of sustainable development enshrined in Vision 2030, Egypt's long-term economic development plan.
      ...
      Ø Identify and highlight the tools, techniques and roadmaps adopted by decision makers to apply and evaluate sustainability goals in their organizations in the context of the Sustainable Development Goals (SDGs)
      Ø Develop an updated road map for industrial development in light of the dimensions and objectives of sustainability.
      Ø Discussing the obstacles and challenges facing sustainable industrial development
      ...
      Reducing emissions and waste resulting from\n operation
    ...
    },
    {
      ...
      sumDesc: `Companies need to focus on improving their absorptive capacity in order to improve their
